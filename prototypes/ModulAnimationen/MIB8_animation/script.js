...
function animateBos() {
    ...
    tl.sizeBlink(arrowL)
        .colorBlink(getGrid(1, 4), {
            fill: red
        })
        .colorBlink(getGrid(1, 3), {
            fill: red
        })
        .colorBlink(getGrid(1, 2), {
            fill: red
        })
        .colorBlink(getGrid(1, 1), {
            fill: red,
            repeat: 0
        })
        .sizeBlink(arrowR)
        .colorBlink(getGrid(3, 4), {
            fill: blue
        })
        .colorBlink(getGrid(3, 3), {
            fill: blue
        })
        .colorBlink(getGrid(3, 2), {
            fill: blue
        })
        .colorBlink(getGrid(3, 1), {
            fill: blue,
            repeat: 0
        })
        .sizeBlink(arrowL)
...
function animateIDE() {
    ...
    viewTl.to(viewCode, {
        ...
        .scaleIncrementX(viewCode.children[0], {
            scale: 0.5
        })
        .scaleIncrementX(viewCode.children[7], {
            scale: 1.2
        }, ">0.5")
        .scaleIncrementX(viewCode.children[3], {
            scale: 0,
            delay: 0.03
        }, ">0.5")
        .scaleIncrementX(viewCode.children[13], {
            scale: 1.4
        }, ">0.5")
        .to(viewCode, {
            opacity: 0
    ...
    modelTl.to(modelCode, {
            opacity: 1
        })
        .to(modelTab, {
            fill: selectColor
        }, "<")
        .scaleIncrementX(modelCode.children[5], {
            scale: 0.5
        })
        .scaleIncrementX(modelCode.children[12], {
            scale: 1.2
        }, ">0.5")
        .scaleIncrementX(modelCode.children[2], {
            scale: 0,
            delay: 0.03
        }, ">0.5")
        .scaleIncrementX(modelCode.children[7], {
            scale: 1.4
        }, ">0.5")
        .scaleIncrementX(modelCode.children[10], {
            scale: 1.4
        }, ">0.5")
        .to(modelCode, {
            opacity: 0
    ...
    controllerTl.to(controllerCode, {
            opacity: 1
        })
        .to(controllerTab, {
            fill: selectColor
        }, "<")
        .scaleIncrementX(controllerCode.children[0], {
            scale: 0
        })
        .scaleIncrementX(controllerCode.children[1], {
            scale: 0
        }, ">0.5")
        .scaleIncrementX(controllerCode.children[2], {
            scale: 0,
            delay: 0.03
        }, ">0.5")
        .scaleIncrementX(controllerCode.children[0], {
